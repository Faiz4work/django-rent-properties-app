...
class ClientDoc(models.Model):
    ...
    client_id = models.ForeignKey(Client, on_delete=models.CASCADE, db_constraint=False)
...
class PropertyDoc(models.Model):
    file = models.FileField(upload_to='static/documents/')
    property_id = models.ForeignKey(Property, on_delete=models.CASCADE, db_constraint=False)
